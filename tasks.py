...
@task
def minimal_task():
    rcc_location = os.environ.get("RCC_EXE", "rcc")
    ...
    metbot_run = subprocess.Popen([f"{rcc_location} run --space metarobot --task metarobot"], shell=True, cwd=r"/Users/tim/Documents/Robot Tests/No Data Leaving Prem Bot Run/metarobot")
